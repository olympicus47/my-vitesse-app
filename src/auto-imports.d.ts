...
declare global {
  ...
  const useLocatiiDbStore: typeof import('./store/locationsDbStore')['useLocatiiDbStore']
...
declare module '@vue/runtime-core' {
  interface ComponentCustomProperties {
    ...
    readonly useConnectionStore: UnwrapRef<typeof import('./store/connectionStore')['useConnectionStore']>
    ...
    readonly useLocatiiDbStore: UnwrapRef<typeof import('./store/locationsDbStore')['useLocatiiDbStore']>
